...
<br>
<br>
💡 외국어로 세상과 소통하던 경험을 바탕으로, 현재는 C/C++ 기반 임베디드 시스템 개발을 통해 Linux 커널 및 하드웨어 저수준 계층과 상호작용하는 소프트웨어를 학습하고 있습니다.
특히 디바이스 드라이버와 I2C·GPIO 기반 하드웨어 제어 구조를 중심으로 부트로더부터 커널 영역까지의 동작 흐름을 이해하며 실제 시스템 관점에서의 구조를 익히고 있습니다.
이러한 이해를 바탕으로 안정적으로 동작하는 임베디드 시스템을 구현할 수 있는 개발자로 성장하는 것을 목표로 하고 있습니다.
...
* **🔬 Practice: Intel Geti를 활용한 AI Classification & Detection 실습** 
    * **분석 성과:** Classification 성능 정량 분석 및 Detection 일반화 성능에 미치는 데이터/Bounding Box 설계 영향과, score 지표와 실제 성능 간 괴리를 통한 데이터 중심 접근(Data-Centric AI)의 중요성
...
<br>
<br>
💡 外国語を通じて多様な環境や人々とコミュニケーションを取ってきた経験を基に、現在はC/C++による組み込みシステム開発を通じて、Linuxカーネルおよびハードウェアの低レイヤ層と相互作用するソフトウェアの学習に取り組んでいます。特にデバイスドライバやI2C・GPIOベースのハードウェア制御構造を中心に、ブートローダからカーネル領域までの動作の流れを理解し、システム全体を俯瞰した設計視点の習得に励んでいます。これらを通じて、安定した組み込みシステムを実装できるエンジニアとして成長することを目標としています。
...
![GitHub Stats](https://github-readme-stats.vercel.app/api?username=ryukb727&show_icons=true)
![Top Languages](https://github-readme-stats.vercel.app/api/top-langs/?username=ryukb727&layout=compact)
...
## 📫 Contact:
 ...
 <img src="https://img.shields.io/badge/Gmail-EA4335?style=flat&logo=Gmail&logoColor=white&link=mailto:ryukb727@gmail.com"> **ryukb727@gmail.com**
